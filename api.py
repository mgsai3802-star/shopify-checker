...
# =========================================================
# ဈေးနှုန်း 0 သို့မဟုတ် Free ဖြစ်မှုကို ရှောင်ရှားပြီး အပေါဆုံးပစ္စည်းကို ယူမည့်စနစ်
# =========================================================
        ...
        for product in result:
            ...
            for variant in product['variants']:
                ...
                try:
                    ...
                    # ဈေးနှုန်း 0 ထက်ကြီးမှသာ လက်ခံမည် (Free ပစ္စည်းများကို ကျော်မည်)
    ...
    try:
        ...
        async with aiohttp.ClientSession(connector=connector, timeout=timeout) as session:
            ...
            if not subtotal:
                ...
                subtotal = price_match.group(1) if price_match else "1.00"
